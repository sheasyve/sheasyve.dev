...
function SimpleCrushProject() {
    ...
    const features = [
        ...
        "Custom Themes: Choose from 8 unique color palettes or add your own custom themes from files.",
        ...
        "Resizable UI: Fully scalable interface ensuring comfortable usability across any monitor size or resolution."
    ];
