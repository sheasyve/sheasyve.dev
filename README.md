...
### Tech Stack
* **Core:** React 18, CSS
* **Build System:** Custom Webpack 5 (Code splitting, MiniCSSExtractPlugin, Asset hashing, Minification)
* **Styling:** PostCSS with Autoprefixer
* **Routing:** React Router (HashRouter)

### Scripts
* **npm run start**: Dev server with HMR and React Fast Refresh.
* **npm run deploy**: Production build and automated deployment to custom domain.
